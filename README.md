...
You may choose to enable a plugin that colours links to nonexistent files red, in the same file, but with the warning that the plugin may not be entirely stable.
